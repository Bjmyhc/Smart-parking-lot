...
static void OTA_Process(void)
{
    ...
    else
    {
        ...
        {
            USART1_PutString("[BOOT] CRC32§µ?????! ???APP\r\n");
        ...
        {
            USART1_PutString("[BOOT] CRC32§µ?????! calc=");
